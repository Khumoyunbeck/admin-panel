                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form autoComplete="off" class="el_form page_form" onSubmit={(e) => {
                                        ...
                                        fetch('http://192.168.3.24:3001/sub_categories/edit', {
                                            method: 'POST',
                                            headers: {
                                                'Accept': 'application/json',
                                                'Content-Type': 'application/json'
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10" >
                                                <select class="filter_selector form-control" name="menu_id" defaultValue={found.filter_id} ref={page_filter_id}>
                                                    <option value="0">Kerak emas</option>
